...
blue: 
	rsync ~/one_commit_alectrico_site /run/user/1000/gvfs/smb-share:server=bigblue,share=publisher/ -r --progress --outbuf=N  -T=/tmp --exclude-from lista_alectrico --delete
	#sync ~/one_commit_alectrico_site /run/user/1000/gvfs/smb-share:server=bigblue,share=public/ -r --progress --outbuf=N  -T=/tmp 
